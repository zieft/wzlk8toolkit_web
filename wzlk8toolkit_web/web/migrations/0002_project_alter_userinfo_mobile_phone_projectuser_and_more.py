    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.SmallIntegerField(
                    choices=[(1, '#56b8eb'), (2, '#f28033'), (3, '#ebc656'), (4, '#a2d148'), (5, '#20BFA4'),
                             (6, '#7461c2'), (7, '#20bfa3')], default=1, verbose_name='Color')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='invites', to='web.userinfo', verbose_name='Invitor')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.project',
                                              verbose_name='Project')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects',
                                           to='web.userinfo', verbose_name='User')),
            ],
        ),
        migrations.AddField(
            model_name='project',
